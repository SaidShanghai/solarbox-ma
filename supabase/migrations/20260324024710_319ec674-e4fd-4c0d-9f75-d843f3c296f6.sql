UPDATE blog_posts
SET content = '## Introduction : Pourquoi le dimensionnement est la clé de votre projet solaire
...
**Contactez SOLARBOX dès aujourd''hui pour une étude de dimensionnement gratuite et personnalisée de votre projet.** Redonnez du pouvoir à votre toiture !'
WHERE id = 'e6151cf3-e8e9-449a-8db4-f7cc099428aa';