...
const heroWords = ["Le conseil,", "Le projet,", "Le pilotage,", "Le parcours,", "Le déploiement,", "Le matériel,"];
    ...
    <>
      ...
      <section className="w-screen h-screen flex-shrink-0 flex items-center overflow-hidden pt-16 relative" style={{ backgroundColor: "#5a8bb5" }}>
        ...
        <div className="container mx-auto px-4 relative z-10 overflow-hidden">
          <div className="grid lg:grid-cols-[1.1fr_minmax(0,360px)_0.85fr] gap-4 items-center">
            ...
            >
              <div className="inline-flex items-center gap-3 px-6 py-3 bg-primary/10 rounded-full">
                ...
                <span className="text-xl md:text-2xl font-semibold">Facture électrique trop chère ?</span>
              </div>
              ...
              <div className="flex flex-col gap-3 lg:hidden pt-4">
                {/* Trust indicators — mobile (just above CTA) */}
                <div className="flex items-start justify-center gap-8 pb-2 [text-shadow:_0_1px_8px_rgb(0_0_0_/_0.7)]">
              ...
              <div className="hidden lg:flex items-start gap-8 pt-8 mt-[60px] [text-shadow:_0_1px_8px_rgb(0_0_0_/_0.7)]">
                <div className="text-center">
                  <AnimatedCounter end={STATS.diagnostics.value} suffix={STATS.diagnostics.suffix} className="text-3xl font-bold text-background" />
                  <div className="text-sm font-medium text-background/90">{STATS.diagnostics.label}</div>
                </div>
                ...
                >
                  <div className={`w-[54px] h-[54px] shrink-0 z-10 rounded-xl p-1.5 transition-all duration-500 ${
                    isActive
                      ...
                      : "text-foreground/80 bg-transparent border border-dashed border-border group-hover:border-primary/40 group-hover:text-primary"
                  }`}>
                    {step.sketch}
                  </div>
          ...
          {/* Chevron demi-soleil → slide to page 2 */}
          {heroSlide === 0 && (
            <button
              onClick={() => setHeroSlide(1)}
              className="absolute right-0 top-1/2 z-20 flex items-center justify-center w-[50px] h-[50px] lg:w-20 lg:h-20 rounded-l-full bg-primary/90 shadow-lg shadow-primary/30 hover:bg-primary transition-colors group"
              style={{ transform: "translateY(calc(-50% + 115px))" }}
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <div className="mt-2 bg-background/60 backdrop-blur-sm rounded-xl border border-border/50 px-5 py-3 max-w-sm">
              ...
              <p className="text-[10px] text-muted-foreground mb-1.5">Certains composants (batterie / onduleur) peuvent être remplacés sur la durée.</p>
          ...
          >
            {features.map((feature, index) => (
              <div key={feature.title} className="text-center bg-background/70 backdrop-blur-sm rounded-xl p-2.5 border border-border/50" style={{ maxWidth: 230 }}>
          ...
          <motion.div
            ...
            className="pt-1 -mt-[10px] grid grid-cols-2 lg:grid-cols-4 gap-4 lg:w-4/5"
          >
            {[
