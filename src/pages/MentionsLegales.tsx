...
const schema = {
  ...
  "@type": "WebPage",
  url: "https://solarbox.ma/mentions-legales",
    ...
    <>
      ...
      <LegalPageLayout title="Mentions Légales" icon="file" lastUpdated="14 mars 2026" sections={sections}>
        ...
        <section id="editeur">
          ...
          <p>Le site internet solarbox.ma (ci-après « le Site ») est édité par :</p>
          <p>
            ...
            Email de contact : privacy@solarbox.ma<br />
        ...
        <section id="directeur">
          ...
          <p>Conformément aux dispositions légales en vigueur, le directeur de la publication est responsable du contenu éditorial publié sur le Site. Toute demande relative au contenu du Site peut être adressée à l'adresse email : privacy@solarbox.ma.</p>
        </section>
        ...
        <section id="donnees">
          ...
          <p>Les modalités de collecte, les finalités des traitements, les durées de conservation, les mesures de sécurité et les droits des utilisateurs sont décrits de manière exhaustive dans la <Link to="/privacy" className="text-primary underline font-medium">Politique de Confidentialité</Link>, accessible à l'adresse : solarbox.ma/privacy.</p>
          <p>Conformément aux articles 7, 8 et 9 de la loi n°09-08, les utilisateurs disposent d'un droit d'accès, de rectification, de suppression et d'opposition sur leurs données personnelles. Pour exercer ces droits, il convient d'adresser une demande par email à : <strong>privacy@solarbox.ma</strong>.</p>
        ...
        <section id="droit-applicable">
          ...
          <p>Préalablement à toute action judiciaire, les parties s'engagent à rechercher une solution amiable dans un délai de 30 jours à compter de la notification du différend par l'une des parties à l'autre, par lettre recommandée avec accusé de réception ou par email à l'adresse privacy@solarbox.ma.</p>
        </section>
